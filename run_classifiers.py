...
print("Time taken by classifier_lr.py:", end-start)

start = time.time()
exec(open("classifier_dt.py").read())
end = time.time()
print("Time taken by classifier_dt.py:", end-start)

start = time.time()
exec(open("classifier_rf.py").read())
end = time.time()
print("Time taken by classifier_rf.py:", end-start)

start = time.time()
exec(open("classifier_et.py").read())
end = time.time()
print("Time taken by classifier_et.py:", end-start)

start = time.time()
exec(open("classifier_gradient_boosting.py").read())
end = time.time()
print("Time taken by classifier_gradient_boosting.py:", end-start)

start = time.time()
exec(open("classifier_adaboost.py").read())
end = time.time()
print("Time taken by classifier_adaboost.py:", end-start)

start = time.time()
exec(open("classifier_nb.py").read())
end = time.time()
print("Time taken by classifier_nb.py:", end-start)

start = time.time()
exec(open("classifier_mda_qda.py").read())
end = time.time()
print("Time taken by classifier_mda_qda.py:", end-start)

start = time.time()
exec(open("classifier_svm.py").read())
end = time.time()
print("Time taken by classifier_svm.py:", end-start)

start = time.time()
exec(open("classifier_rough_set.py").read())
end = time.time()
print("Time taken by classifier_rough_set.py:", end-start)

start = time.time()
exec(open("classifier_ann.py").read())
end = time.time()
print("Time taken by classifier_ann.py:", end-start)
